        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="description" placeholder="Brief description of the book" rows="4"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent text-sm">{{ old('description', $book->description) }}</textarea>
                        </div>
                    </div>
                </div>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input type="checkbox" name="is_published"
                            class="w-5 h-5 rounded border-gray-300 text-emerald-600 focus:ring-emerald-500" value="1" {{ old('is_published', $book->is_published) ? 'checked' : '' }}>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Upload new image to replace</p>
                    @error('cover_image')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
