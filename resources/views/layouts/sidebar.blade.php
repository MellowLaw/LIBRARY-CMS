<div class="w-64 bg-[#efeae4] border-r border-[#e5e7eb] flex flex-col">
    ...
    <div class="border-t border-[#e5dcd6] px-4 py-4 space-y-2">
        ...
        <a href="{{ route('profile.edit') }}"
            class="flex items-center gap-3 px-4 py-3 rounded-lg transition-smooth font-medium {{ request()->routeIs('profile.*') ? 'bg-white text-[#ec3412] shadow-sm ring-1 ring-[#e5e7eb]' : 'text-[#0f0701] hover:bg-white/50 hover:text-[#ec3412]' }}">
            <svg class="w-5 h-5 {{ request()->routeIs('profile.*') ? 'text-[#ec3412]' : 'text-gray-400 group-hover:text-[#ec3412]' }}"
                fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
