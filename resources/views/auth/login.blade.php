        ...
        <div
            ...
            <div class="mx-auto w-full max-w-sm lg:w-96">
                <div class="sm:mx-auto sm:w-full sm:max-w-md mb-6">
                    ...
                    <h2 class="mt-8 text-3xl font-bold tracking-tight text-slate-900 text-center">Sign in to your account</h2>
                ...
                <div class="mt-10">
                    ...
                    <div class="flex justify-center mb-6 relative h-20">
                        <div id="user-avatar"
                            class="w-20 h-20 rounded-full bg-slate-100 flex items-center justify-center border-4 border-white shadow-lg transition-all duration-500 ease-out transform">
                            <!-- Default User Icon -->
                            <svg id="icon-user"
                                class="w-10 h-10 text-slate-400 params-transition transition-all duration-300 transform scale-100 opacity-100"
                            ...
                            <svg id="icon-admin"
                                class="w-10 h-10 text-orange-600 params-transition transition-all duration-300 absolute transform scale-50 opacity-0"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div id="typing-indicator"
                            class="absolute -right-4 top-0 bg-white p-2 rounded-full shadow-md hidden animate-bounce-subtle">
