...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
    ...
    <div class="prose max-w-none">
        @if($page->sections->count() > 0)
            ...
            @endforeach
        @else
            <p class="text-gray-500 italic">No content sections yet.</p>
        @endif
    </div>
    ...
    <div class="mt-8 pt-6 border-t border-gray-200 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('pages.edit', $page) }}" class="px-4 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-smooth font-medium">
                Edit Page
            </a>
            <a href="{{ route('pages.index') }}" class="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-smooth font-medium text-gray-700">
                Back to List
            </a>
        </div>
    </div>
