    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4 animate-fade-in-up">
            <div>
                <nav class="flex mb-2" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="{{ route('dashboard') }}" class="text-gray-500 hover:text-primary-accent transition-colors text-sm font-medium">Dashboard</a>
                        </li>
                        <li>
             ...
             @if (session('success'))
                <div class="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg flex items-center animate-fade-in shadow-sm">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-center h-full">
                        ...
                        <div class="relative inline-block group mb-6">
                            <div class="w-40 h-40 rounded-full overflow-hidden border-4 border-gray-50 shadow-md mx-auto relative group-hover:border-primary-accent/20 transition-colors">
                                @if ($user->profile_picture)
                                    <img id="profile-preview" src="{{ asset('storage/' . $user->profile_picture) }}" alt="Profile" class="w-full h-full object-cover">
                                @else
                                    <div id="profile-placeholder" class="w-full h-full flex items-center justify-center bg-gray-100 text-gray-400 font-bold text-5xl">
                            ...
                            {{-- Edit Button (Visible) --}}
                            <button type="button" onclick="document.getElementById('profile_picture').click()" class="absolute bottom-2 right-2 bg-white text-gray-700 p-2 rounded-full shadow-lg border border-gray-100 hover:text-primary-accent transition-colors">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                            </button>
                        </div>
                        
                        <input type="file" name="profile_picture" id="profile_picture" class="hidden" onchange="previewImage(this)">
                        ...
                        <div class="text-center">
                            ...
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-primary-bg text-primary-text border border-primary-accent/20 uppercase tracking-widest">
                                {{ $user->role }}
                            </span>
                ...
                <div class="lg:col-span-2 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                        <div class="flex items-center gap-3 mb-6 pb-4 border-b border-gray-100">
                            <div class="w-10 h-10 rounded-full bg-orange-50 text-primary-accent flex items-center justify-center">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <input type="text" name="first_name" id="first_name" value="{{ old('first_name', $user->first_name) }}"
                                    class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-primary-accent/20 focus:border-primary-accent focus:bg-white transition-all outline-none" required>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                        ...
                        <div class="space-y-6">
                            <div class="space-y-2">
                                <label for="current_password" class="text-sm font-semibold text-gray-700">Current Password <span class="text-gray-400 font-normal">(Leave blank if unchanged)</span></label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    <label for="new_password_confirmation" class="text-sm font-semibold text-gray-700">Confirm New Password</label>
                    ...
                    <div class="flex items-center justify-end gap-4 p-4">
                        <a href="{{ route('dashboard') }}" class="text-gray-500 font-bold hover:text-gray-800 transition-colors">Cancel</a>
                        <button type="submit" 
                        ...
                        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div>
                                ...
                                <p class="text-gray-600 text-sm mt-1">
                                    Once you delete your account, there is no going back. All of your personal data will be permanently removed.
                                </p>
                            </div>
                            <button type="button" onclick="openDeleteModal()" class="px-6 py-2 bg-red-600 text-white font-bold rounded-lg hover:bg-red-700 transition-colors shrink-0">
                                Delete Account
                            </button>
                        </div>
                    </div>
    ...
    <div id="deleteModal" class="fixed inset-0 z-50 hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        ...
        <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
            <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg border-2 border-red-100">
                    <form action="{{ route('profile.destroy') }}" method="POST" class="p-6">
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="mt-4">
                                        <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-1">Please enter your password to confirm:</label>
                        ...
                        <div class="mt-8 sm:flex sm:flex-row-reverse gap-3">
                            <button type="submit" class="inline-flex w-full justify-center rounded-lg bg-red-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:w-auto transition-colors">Delete Account</button>
                            <button type="button" onclick="closeDeleteModal()" class="mt-3 inline-flex w-full justify-center rounded-lg bg-white px-4 py-2.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:mt-0 sm:w-auto transition-colors">Cancel</button>
                        </div>
                    </form>
                </div>
            </div>
