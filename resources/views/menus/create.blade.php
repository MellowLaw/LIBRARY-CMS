...
<div class="max-w-2xl">
    <form method="POST" action="{{ route('menus.store') }}" class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
            <div>
                <label class="block text-sm font-semibold text-gray-900 mb-2">Name (Internal) <span class="text-red-500">*</span></label>
            ...
            <div>
                <label class="block text-sm font-semibold text-gray-900 mb-2">Label (Display) <span class="text-red-500">*</span></label>
            ...
            <div>
                ...
                <select name="parent_id" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500">
            ...
            <div class="flex items-center gap-2">
                <input type="checkbox" name="is_visible" id="is_visible" value="1" checked class="w-4 h-4 rounded border-gray-300">
        ...
        <div class="flex items-center gap-3">
            ...
            <a href="{{ route('menus.index') }}" class="px-6 py-2.5 border border-gray-300 rounded-lg hover:bg-gray-50 transition-smooth font-medium text-gray-700">
                Cancel
            </a>
        </div>
    </form>
