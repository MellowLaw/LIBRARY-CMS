...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('menus.create') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-smooth font-medium">
                ...
                <div class="menu-item bg-gray-50 p-4 rounded-lg border-2 border-gray-200 hover:border-emerald-300 cursor-move group transition-smooth"
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4 flex-1">
                            <svg class="w-5 h-5 text-gray-400 opacity-0 group-hover:opacity-100 transition-opacity" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M10 6a2 2 0 11-4 0 2 2 0 014 0zM14 6a2 2 0 11-4 0 2 2 0 014 0zM10 12a2 2 0 11-4 0 2 2 0 014 0zM14 12a2 2 0 11-4 0 2 2 0 014 0zM10 18a2 2 0 11-4 0 2 2 0 014 0zM14 18a2 2 0 11-4 0 2 2 0 014 0z"/>
                            </svg>
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <a href="{{ route('menus.edit', $menu) }}" class="p-2 text-gray-600 hover:bg-white rounded-lg transition-smooth">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                            </a>
                            
                            <form method="POST" action="{{ route('menus.destroy', $menu) }}" class="inline" onsubmit="return confirm('Delete this menu item?')">
                                @csrf
                                @method('DELETE')
    ...
    <!-- Save Button -->
    <button onclick="saveMenuOrder()" class="inline-flex items-center gap-2 px-6 py-2.5 bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition-smooth font-medium">
        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    function saveMenuOrder() {
        ...
        fetch('/api/menus/reorder', {
            ...
            headers: {
                ...
                'Authorization': `Bearer ${document.querySelector('[data-token]').dataset.token}`
            },
