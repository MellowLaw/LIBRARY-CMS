        ...
        <div class="divide-y divide-gray-200">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-4 mt-2">
                                <a href="{{ $resource->url }}" target="{{ $resource->is_external ? '_blank' : '_self' }}"
            ...
            @empty
                <div class="p-12 text-center">
                    <p class="text-gray-500">No resources yet. <a href="{{ route('resources.create') }}"
                            class="text-emerald-600 hover:text-emerald-700">Add one</a></p>
                </div>
            @endforelse
        </div>
